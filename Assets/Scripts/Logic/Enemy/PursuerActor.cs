...
public class PursuerActor : MonoBehaviour
{
    ...
    [SerializeField] private float _tier4ViewportY = 0.45f;
    ...
    {
        _isSleeping = curr == InGameState.Wait;
        TransitionToTierState();
    }
    ...
    public void PlayAnimation(PursuerAnimationState state)
    {
        switch (state)
        {
            ...
            case PursuerAnimationState.Climb: PlayAnimation(CLIMB); break;
        }
    }
    ...
    private void OnDrawGizmosSelected()
    {
        ...
        var tiers = new (int tier, float y, Color color)[]
        {
            ...
            (4, _tier4ViewportY, Color.magenta),
        };
